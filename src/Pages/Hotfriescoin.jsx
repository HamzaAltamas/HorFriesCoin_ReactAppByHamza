...
export const Hotfriescoin = () => {
  return (
    <>
       <title>About | HotFriesCoin</title>v
      <CommonBanner bannerheading="ABOUT HORFRIESCOIN" />
      <div className="container mb-5 mt-5 aboutHotfriesacoin">
        <h2 className="mb-3">HOTFRIESCOIN IS NEW ASSET CLASS.</h2>
        <p>
          ...
          and never decrease in value. HOTFRIESCOIN is just that currency. To
          ...
          in the market that an initial supply, at Hotfriescoin the initial
          ...
          occurred a 10% is applied and distributed to all HOTFRIESCOIN holders.
          Hotfriescoin can only be bought with stablecoin (BUSD) to guarantee
          price stability. This fundamental tokenomics conception allowed us to
          create the world’s first Stable Progressive Coin.
        </p>
      </div>
    </>
  )
